...
<template>
  <div class="player" v-show="playlist.length > 0">
    ...
    <transition name="mini">
      ...
      <div class="control">
        <progress-circle :radius="radius" :percent="percent"> <!--固定的值不需要加冒号-->
  ...
  export default{
    ...
    methods: {
      ...
      onProgressBarChange(percent) {
        // currentTime属性设置或返回音频/视频播放的当前位置（以秒计）
